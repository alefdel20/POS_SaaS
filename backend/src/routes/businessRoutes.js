...
router.post("/:id/subscription/register-payment", requireRole(["superusuario", "superadmin"]), controller.registerSubscriptionPaymentValidation, controller.registerBusinessSubscriptionPayment);
