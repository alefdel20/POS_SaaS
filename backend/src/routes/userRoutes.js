...
const { authedResetLimiter } = require("../middleware/rateLimiters");
...
router.post("/:id/reset-password", requireRole(["superusuario", "superadmin"]), authedResetLimiter, controller.resetPasswordValidation, controller.resetPassword);
