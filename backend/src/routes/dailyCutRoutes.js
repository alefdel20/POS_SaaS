...
router.get("/export", requireRole(["superadmin", "superusuario", "admin"]), exportLimiter, controller.exportValidation, controller.exportDailyCuts);
...
router.get("/hourly", requireRole(["superadmin", "superusuario", "admin", "gerente", "cajero", "cashier"]), controller.hourlyValidation, controller.getHourlySales);
