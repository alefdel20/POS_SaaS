...
const errorTranslations: Record<string, string> = {
  ...
  Forbidden: "No tienes permisos para entrar aquí",
  ...
  "Unable to generate unique SKU": "No fue posible generar un SKU único",
  "Product name is required": "El nombre del producto es obligatorio",
  "Product category is required": "La categoría del producto es obligatoria",
  ...
  "Product minimum stock cannot be negative": "El stock mínimo no puede ser negativo",
  "Product maximum stock cannot be negative": "El stock máximo no puede ser negativo",
  "Product maximum stock cannot be lower than minimum stock": "El stock máximo no puede ser menor al stock mínimo",
  "At least one real change is required": "Debe existir al menos un cambio real",
  ...
  "Discount configuration is incomplete": "La configuración del remate está incompleta",
  ...
  "Loan note is required": "La nota es obligatoria para movimientos de deuda del dueño",
  "Void reason is required": "Debes capturar un motivo de anulación",
  ...
  "Owner loan not found": "Movimiento del dueño no encontrado",
  "Owner loan is already voided": "El movimiento del dueño ya fue anulado",
  ...
  "Preventive event type is invalid": "El tipo de evento preventivo es inválido",
  "Preventive event status is invalid": "El estado del evento preventivo es inválido",
  "Patient weight is invalid": "El peso del paciente es inválido",
  ...
  "Sesión expirada": "Tu sesión expiró. Vuelve a iniciar sesión para continuar."
};
