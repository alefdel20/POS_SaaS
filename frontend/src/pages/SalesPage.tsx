...
import { escapeHtml, printHtmlDocument, THERMAL_PRINTABLE_WIDTH_MM, THERMAL_PRINTABLE_LEFT_OFFSET_MM } from "../utils/print";
  ...
  async function printLastTicket() {
    ...
    const bodyHtml = `
      <style>
        ...
        @media print {
          body { width: ${THERMAL_PRINTABLE_WIDTH_MM}mm; margin: 0 0 0 ${THERMAL_PRINTABLE_LEFT_OFFSET_MM}mm; padding: 4px; }
        }
      </style>
